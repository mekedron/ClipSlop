...
<img
  src={useBaseUrl('/demos/screenshots/openai-signin.png')}
  alt="OpenAI Sign In provider configuration — sign in button, account status, model picker"
...
If you're curious about how the OAuth + PKCE handshake works, the [Develop → ChatGPT OAuth](../../develop/chatgpt-oauth.md) page has the technical details.
