...
Open **Settings** from the menu-bar icon (or press `⌘,`). The General tab covers shortcut customisation, theme, and launch-at-login:
...
- **[Sign in with ChatGPT](./providers/chatgpt.mdx)** — free, OAuth-based, no API key needed. Best starting point.
...
That's **Quick Paste**. For something fancier, see [How it works](./how-it-works.mdx).
