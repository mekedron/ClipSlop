...
| **Keyboard-first**      | ✅ Single-key mnemonics, Inline Run, Run in Editor, OCR (`⇧⌘2`)                                                | ⚠️ Shortcut + picker  | ⚠️ Hotkey + picker | ⚠️ ⌥C hotkey | ⚠️ Per-prompt | ⚠️ Shortcut + menu | ⚠️ Super Command | ⚠️ Custom shortcuts | ⚠️ Shortcuts + `//` | ⚠️ Launcher | ❌ Mouse-driven | ❌ Browser UI |
